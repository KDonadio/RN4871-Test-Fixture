...
#--------------------------------------------------
# Create the window
window = sg.Window("RN4871/BM71 Devce Firmware Update Tool", layout, size=(600, 300))
...
while True:
    ...
    # CFG Mode button
    if event == "CFG Mode":
#        print("CFG mode pressed")
        CFG_Mode()
    # --------------------------------------------------
    # APP Mode button
    if event == "APP Mode":
#        print("APP mode pressed")
        APP_Mode()
    # --------------------------------------------------
    # LED Red On button
    if event == "LED Red On":
...
#            print("Update pressed")
            ...
            APP_Mode()
            LED_Red_Off()
            sg.Popup('Programming complete.', no_titlebar=1, background_color='dark red')
            LED_Green_On()
